                    ...
                    <div class="footer-widget">
                        <div class="footer-widget-explore">
                            ...
                            <li><a href="history.php">Brief History</a></li>
								<li><a href="./pages/corporate.php">Corporate Profile</a></li>
								<li><a href="./pages/chairperson.php">Founder & Proprietor</a></li>
								<li><a href="./pages/boardmember.php">Management Board</a></li>
								<li><a href="./pages/secretariat.php">CRSM Secretariat</a></li>
                            </ul><!-- list-unstyled -->
                ...
                <div class="col-lg-2">
                    <div class="footer-widget">
                        <div class="footer-widget-department">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="./pages/Secretariat.php">CRSM secretariat</a></li>
                                <li><a href="department-details.html">Training</a></li>
                                <li><a href="department-details.html">Finance</a></li>
                                <li><a href="department-details.html">Evaluation</a></li>
                                <li><a href="department-details.html">Learning centers</a></li>
                            </ul><!-- list-unstyled -->
...
<script src="./model/jquery-3.6.0.min.js"></script>
<script src="./model/ajax_jquery.js"></script>
