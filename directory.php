			...
			<div class="col-lg-4">
				<div class="blog-card">
					<div class="blog-card-image">
						<img src="http://portal.crsm.ng<?php echo substr($data["schLogo"], 2) ?? ""; ?>" class="img-fluid" alt="<?php echo $data["sch_code"] ?? ""; ?>" style="height: 50%; width:50%;  display: block; margin-left: auto;margin-right: auto; ">
					</div><!-- blog-card-image -->
